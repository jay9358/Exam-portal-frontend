...
export default function CityManagerLogin() {
    ...
    async function LoginAccount() {
        ...
        const logindata = { contact: data.email, otp: data.otp, flag: "CityManager" };
        ...
        if (loginaccountresponse?.payload?.data?.success === true) {
            ...
            localStorage.setItem('flag', 'CityManager');
            localStorage.setItem('userId', loginaccountresponse?.payload?.data?.userDetails?._id);
            // Navigate to the city manager dashboard
            navigate('/citymanagerreports');
        } else {
        ...
        <>
            <div className="signin-container">
                <div className="signin-form">
                    ...
                    <h2 className="signin-title">City Manager Login</h2>
